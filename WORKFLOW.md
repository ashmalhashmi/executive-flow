...
| 2 | You | Quick log anytime | **Quick Log Souvenir** → date + detail → **Log Souvenir** (meeting optional) |
| 3 | Optional | From calendar day | **My Calendar** → **Log Souvenir** (meeting pick optional — walk-in OK) |
...
| 3 | You | Export PDF | **Download PDF** — opening date → today, category groups + subtotals, Opening / Total / Closing |
| 4 | Optional | Weekly email / PDF | **Sync & Backup** → weekly expenditure card / settings (job runs on schedule) |

---

### E½. Meeting petty cash (Purchase Slip · Satisfactory · Refreshment)
...
Invoice photo uploads to cloud — only URL kept on device.
...
| 3 | You | Mark received | Row **Received** → Receiving Note sub-section enable (`Rec Note_…`) |
| 4 | You | Export note | Optional **Generate statement (AI)** · then **PDF** / **Word** / **Email** (AI on export if statement empty) |
...
| 2 | You | Enter subject · date · marked to | Form → **Add Dak Entry** (dispatch no. auto) |
...
### K. Compose a letter (Intent → Draft)

| Step | Who | What | Click |
|------|-----|------|-------|
| 1 | You | **Metadata** | **Compose Desk** → Intent (Letter / Note Sheet) + purpose, addressee, reference/PUC, PAFDA header (+ No./File No.) |
| 2 | You | **Content parameters** | Core ideas + tone + language + optional **Presentation** (table / list) |
| 3 | System | **Generate** | **Generate** — AI/local **slots** → official blueprint body |
| 4 | You | **Refine & output** | Review/edit (optional Improve) → **Copy** / **PDF** / **Word** / **Email** |

Do not start from a blank Word page — Intent only.

---

### K2. Print a box / file label (Data → Template)

| Step | Who | What | Click |
|------|-----|------|-------|
| 1 | You (20%) | Open Labels | **File Labels** → **Designation** + size / weight / border / orientation / **copies** → **Save** (cloud list) |
| 2 | System (80%) | Format | Official plate × N copies — PAFDA · legal name · gold divider · designation, one plate per A4 |
| 3 | You | Export | **PDF** / **Word** / **Email PDF** — print one label |

Do not set font size each time — change template code if design must change.
...
| Official letter from ideas | Compose Desk |
| Box / file labels | File Labels |
| Official dispatch log | Dak Issuance Log |
| To-dos | Task Log |
| Quick notes | Capture |
