...
export default function ReminderAlert({ meeting, onDismiss }) {
  return (
    <div
      className="fixed inset-0 z-[200] flex items-end justify-center bg-black/75 p-4 pb-[calc(1rem+var(--safe-bottom))] backdrop-blur-sm sm:items-center"
      role="alertdialog"
      aria-labelledby="reminder-title"
    >
      <div className="w-full max-w-md animate-[tabFadeIn_0.3s_ease-out] rounded-2xl border border-amber-500/40 bg-zinc-900 p-6 shadow-2xl shadow-amber-500/20">
        ...
        <h2 id="reminder-title" className="mt-2 text-xl font-semibold text-white">
          {meeting.title}
        </h2>
